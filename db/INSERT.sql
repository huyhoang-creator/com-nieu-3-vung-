...
INSERT INTO MON_AN (ten, mo_ta, gia, hinh_anh, id_danh_muc, id_vung_mien, dac_trung, trang_thai) VALUES
...
-- Thêm dữ liệu vào bảng MON_AN (Miền Trung)
...
-- Thêm dữ liệu vào bảng MON_AN (Miền Nam)
...
INSERT INTO CHI_NHANH (ten, dia_chi, so_dien_thoai, gio_mo_cua, gio_dong_cua, trang_thai) VALUES
...
INSERT INTO MON_AN_CHI_NHANH (id_mon_an, id_chi_nhanh, tinh_trang) VALUES
-- Chi nhánh Hà Nội
(1, 1, 'con_mon'),
(2, 1, 'con_mon'),
(3, 1, 'con_mon'),
...
INSERT INTO DAT_BAN (id_nguoi_dung, id_ban_an, thoi_gian_dat, thoi_gian_du_kien, so_nguoi, ghi_chu, trang_thai) VALUES
(5, 1, '2025-05-20 09:00:00', '2025-05-21 18:00:00', 4, 'Kỷ niệm sinh nhật', 'da_xac_nhan'),
(6, 8, '2025-05-20 10:30:00', '2025-05-21 19:00:00', 4, 'Gặp đối tác', 'da_xac_nhan'),
(7, 15, '2025-05-20 11:00:00', '2025-05-22 20:00:00', 6, 'Liên hoan gia đình', 'cho_xac_nhan');


-- Thêm dữ liệu vào bảng HOA_DON
INSERT INTO HOA_DON ( id_nguoi_dung, id_ban_an, id_chi_nhanh, thoi_gian_tao, tong_tien, thue_vat, thanh_tien, hinh_thuc, trang_thai, ghi_chu) VALUES
( 5, 1, 1, '2025-05-18 19:30:00', 500000, 42500, 467500, 'tai_cho', 'hoan_thanh', 'Khách hài lòng với món ăn'),
( 6, 8, 2, '2025-05-19 20:15:00', 650000, 58500, 643500, 'tai_cho', 'hoan_thanh', 'Phục vụ tốt'),
( 7, 15, 3, '2025-05-20 12:30:00', 350000, 35000, 385000, 'mang_ve', 'hoan_thanh', 'Đóng gói cẩn thận'),
( 8, 11, 2, '2025-05-20 18:45:00', 200000, 20000, 220000, 'giao_hang', 'hoan_thanh', 'Giao tới địa chỉ công ty'),
(9, 6, 1, '2025-05-20 19:30:00', 900000, 80000, 880000, 'tai_cho', 'hoan_thanh', 'Tiệc gia đình');